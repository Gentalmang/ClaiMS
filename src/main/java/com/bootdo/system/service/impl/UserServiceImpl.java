...
//        user.setRoleIds(roleIds);
    ...
    public int resetPwd(UserVO userVO, UserDO userDO) throws Exception {
        if (Objects.equals(userVO.getUserDO().getUserId(), userDO.getUserId())) {
            if (Objects.equals(MD5Utils.encrypt(userDO.getUsername(), userVO.getPwdOld()), userDO.getPassword())) {
                ...
                throw new Exception("The old password entered is incorrect！");
            }
        } else {
            throw new Exception("What you modified is not the account you logged in！");
        }
    }
    ...
    public int adminResetPwd(UserVO userVO) throws Exception {
        ...
        if ("admin".equals(userDO.getUsername())) {
            throw new Exception("Super admin’s account is not allowed to be reset directly！");
        }
        userDO.setPassword(MD5Utils.encrypt(userDO.getUsername(), userVO.getPwdNew()));
        return userMapper.update(userDO);
