...
public class GenUtils {
    ...
    public static void generatorCode(Map<String, String> table,
        ...
        for (String template : templates) {
            ...
            try {
                ...
                throw new BDException("Failed to render template, table name：" + tableDO.getTableName(), e);
            }
        }
    }
    ...
    public static Configuration getConfig() {
        try {
            ...
            throw new BDException("Failed to obtain configuration file，", e);
        }
    }
...
//		}
        ...
        if (template.contains("doctorEdit.html.vm")) {
            return "main" + File.separator + "resources" + File.separator + "templates" + File.separator
                    + packageName + File.separator + classname + File.separator + "doctorEdit.html";
        }
        ...
        if (template.contains("doctorEdit.js.vm")) {
            return "main" + File.separator + "resources" + File.separator + "static" + File.separator + "js" + File.separator
                    + "appjs" + File.separator + packageName + File.separator + classname + File.separator + "doctorEdit.js";
        }
