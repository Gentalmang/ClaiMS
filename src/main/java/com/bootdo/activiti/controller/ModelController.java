...
public class ModelController extends BaseController{
    ...
    public R deploy(@PathVariable("id") String id) throws Exception {
        ...
        if (bytes == null) {
            return R.error("The model data is empty. Please design the process and save it successfully before publishing.");
        }
        ...
        if (model.getProcesses().size() == 0) {
            return R.error("The data model does not meet the requirements, please design at least one main line process.");
        }
    ...
    public void exportToXml(@PathVariable("id") String id, HttpServletResponse response) {
        try {
            ...
            throw new ActivitiException("Failed to export model xml file, model ID=" + id, e);
        }
    }
}
