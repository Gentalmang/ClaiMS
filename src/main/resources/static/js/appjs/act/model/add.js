	...
	$("#signupForm").validate({
		...
		messages : {
			...
			username : {
				...
				minlength : icon + "Username must have length greater than two",
				remote : icon + "Username already exist"
			},
			password : {
				required : icon + "Please enter your password",
				minlength : icon + "Password must have length greater than six"
			},
			confirm_password : {
			...
			email : icon + "Please enter your E-mail",
		}
	})
}
