						...
						columns : [
								...
								},
								{
									...
									formatter : function(value, row, index) {
										var e = '<a class="btn btn-primary btn-sm" href="#" mce_href="#" title="Generate code" onclick="code(\''
												+ row.tableName
...
function batchCode() {
	...
	if (rows.length == 0) {
		layer.msg("Please select the table to generate code");
		return;
	}
